...
#     index , reg, beneficiaries[index]
    ...
    #     toggle = st.sidebar.button('Wood Tech Builders')
        ...
        if reg == 'Cordillera Administrative Region (CAR)':
            if toggle:
        ...
        if reg == 'National Capital Region (NCR)':
            if toggle:
        ...
        if reg == 'Region II: Cagayan Valley':
            if toggle:
        ...
        if reg == 'Region III: Central Luzon':
            if toggle:
        ...
        if reg == 'Region IV-B: (Mimaropa) Southwestern Tagalog Region':
            if toggle:
                firm = 'Rejanos Bakery'
                st.subheader(beneficiary)
                firm_df = survey_df[survey_df["Name of Your Company:"] == firm]
        ...
        if reg == 'Region VI: Western Visayas':
            if toggle:
        ...
        if reg == 'Region VII: Central Visayas':
            if toggle:
        ...
        if reg == 'Region VIII: Eastern Visayas':
            if toggle:
        ...
        if reg == 'Region IX: Zamboanga Peninsula':
            if toggle:
        ...
        elif reg == 'Region XI: Davao Region':
            if toggle:
        ...
        if reg == 'Region XII: Soccsksargen':
            if toggle:
